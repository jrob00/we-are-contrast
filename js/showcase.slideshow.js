...
showcaseSlideShow.prototype = {
	...
	showInfoSlideShow: function() {
		...
		var slideInfoZoneSpacer = document.createElement('h2');
		slideInfoZoneSpacer.innerHTML = '&nbsp;';
		this.slideInfoZone.appendChild(slideInfoZoneSpacer);
		
		var slideInfoZoneTitle = document.createElement('span');
		slideInfoZoneTitle.className = 'title';
		slideInfoZoneTitle.innerHTML = this.slideShowData[this.currentIter][2];
		this.slideInfoZone.appendChild(slideInfoZoneTitle);
		
		var slideInfoZoneSubTitle = document.createElement('span');
		slideInfoZoneSubTitle.className = 'subTitle';
		slideInfoZoneSubTitle.innerHTML = this.slideShowData[this.currentIter][4];
		this.slideInfoZone.appendChild(slideInfoZoneSubTitle);
		...
		this.slideInfoZone.styles.custom({'opacity': [0, 0.8], 'height': [0, this.slideInfoZone.normalHeight]});
	},
	hideInfoSlideShow: function() {
		this.slideInfoZone.styles.custom({'opacity': [0.8, 0]});
		//this.slideInfoZone.styles.custom({'opacity': [0.8, 0], 'height': [this.slideInfoZone.normalHeight, 0]});
	},
	goTo: function(num) {
